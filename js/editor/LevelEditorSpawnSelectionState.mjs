...
export default class LevelEditorSpawnSelectionState extends LevelEditorSelectionState {
    ...
    initialize(level_editor_reference) {
        ...
        super.getLevelEditor().removeSpawnPosition(super.getButtonId());
    ...
    handleEditorTileClick(caller_id) {
        ...
        if (is_tile_accessible) {
            level_editor.addSpawnPosition(super.getButtonId(), caller_id);
